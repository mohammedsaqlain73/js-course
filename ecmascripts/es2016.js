...
// This operator is similar to using Math.pow() method. Exponentiation operator is represented by a double asterisk **.
...
//  Syntax
// array literl .includes(searchElement);
// array literl .includes(searchElement, fromIndex);
