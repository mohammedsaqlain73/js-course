...
//*  .at()
//* =============
//? Before ES2022, square bracket notation was used to fetch a particular element in an array.
// This method is straightforward unless you need to perform a backward iteration, i.e., negative indexing.
// In the case of negative indexing, the common practice was to use arr[arr.length — N],
...
//* =====================================
//*  Object.hasOwn(obj, propKey) replacing the larger one literal.hasOwnProperty()
//* =====================================
//? Object.hasOwn(obj,"search") is a static method that you can use to check if a property exists in an object or not.
//  It returns true if the specified object contains the indicated property as its own, and if the property is inherited or doesn’t exist, it returns false. This method takes the object as the first argument and the property you want to check as the second.

//? Object.hasOwn is the intended alternative for the Object.prototype.hasOwnProperty method.
// Although Object.prototype.hasOwnProperty has been in JavaScript specification for quite a time, it has some drawbacks.
