...
// It acts as a placeholder for a value that will be provided when the function is called.
...
//* ==============================
//?A FUNCTION CAN BE USED ALSO IN A EQUATION TO ASSIGN A VALUE TO A VARIABLE.THIS LATER CALLED AS ARROW AND ANONYMOUS FUNCTION.

var result = function sum(a, b) {
   console.log(a + b);
 };

 result(10, 15);//NOW IF WE TRY TO CALL SUM NOW WE WILL GET ERROR.LOGIC RESULT=SAQLAIN
 // .IF WANT NAME WILL CALL RESULT NOT SQLAIN AS ALWAYS NAME IS NOT SAQLAIN

//* ==============================
//*  Anonymous Function
//* =============================
//? An anonymous function is a function without a name.
// It can be created using either a function expression or a function declaration without a specific name.

 var result1 = function (a, b) {
   console.log(a + b);
 };

 result1(10, 15);//this is wihtout specific func. name we can also use the func. expression.
...
//here we dont  write any name in function call simply pass value in ().almost same as fe.
// Syntax
// (function () {
//   // code to be executed
// })();
