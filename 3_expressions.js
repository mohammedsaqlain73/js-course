...
// why this occur bcz in js numbers are added by converting to binary in this case
// a big repeating bn if obtained so such result
let result2 = 0.2 + 0.2;
console.log(result2);//output:0.4
//when working with floating-point numbers in js use method
// like tofixed() to precise no od decimal points
console.log(result1.toFixed(2));//output:0.30
//in python "s"*3=sss but in js NaN.
var saq = 3 * 's';
console.log(saq);//output:NaN
...
//? Equal (==): Checks if two values are equal, performing type coercion if necessary i.e
//  even if both numbers are not same datatypes .
 console.log(5 == 5);
 console.log(5 == '5');//does not check datatype only check value

//? Strict Equal (===):
// Checks if two values are equal without performing type coercion
// i.e checks both vakue AND datatype.
 console.log(5 === "5");
...
var s_score = 61;
var result6 = s_score >= 60 ? "pass" : "fail";
console.log(result6);
//* ===================================
...
//* ====================================
 ...
 console.log(2 < 12 < 5);//chaining of comparison operator possible.
