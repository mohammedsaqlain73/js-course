...
if (userAge) {
  if (isCitizen) {
    ...
    }//ISREGISTERED IF IS HERE ITS ELSE IS BELOW.
    else {
      console.log("NOT ELIGIBLE FOR THE VOTE DUE TO NO REGISTRATION");
    }
  }//ISCITIZENSHIP IF CLOSE ITS ELSE PART IS BELOW IT.
  else {
    console.log("YOU ARE NOT ELIGIBLE FOR THE VOTE DUE TO NO CITIZENSHIP");
    }
}//ISCITIZEN IF IS CLOSED AND ITS ELSE PART IS BELOW IT.
else {
  console.log("NOT ELIGIBLE FOR THE VOTE DUE TO THE LACK OF VALID AGE");
}
...
//   default:
//   //  Code to be executed if none of the cases match not compulsory
// }
...
if ((year % 4 === 0 && year % 100 !== 0) || year % 400 === 0) {//divisible by 4 and also by 100 i.e century yr
// then its is confirm that it is cen.yr and then check for 400....don't change the order then logic is chnged.
