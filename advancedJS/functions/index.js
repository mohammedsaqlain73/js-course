...
//*  Callback Functions:
//* -------------------------------
//? Definition: A callback function is a function passed as an argument to another function and
// s executed after the completion of a task.

//---------------------------------------------------------------------------------------------------------------------------------
/*
      higher order function is a function that takes a function as its argument. it can be one or more than one
      callbackfunction is a function wehich is used as  a argument and executed after the completion a task.
...
// Callback function
 ...
 processUserInput("Vinod", greetUser);//this process is a higher order function and greetuser is a callaback function
...
const mathOperation = (a, b, operation) => {
  return operation(a, b); //the opeeration takes the callback function as its name caklled first class function and it is called
};
